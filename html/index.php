...
<head>
	...
	<script src="./html/English_edl.js"></script>
    <style>
    </style>
</head>
<body>
	...
	<form id="demoForm" name="demoForm" onSubmit="return false;">
		<div class="w3-container">
			<div class="w3-left">
				...
				<br>
				<!--
				<input class="w3-check annotator" type="checkbox" checked="checked" id="NER" disabled="true">
				<label class="container">NER</label>
				<label class="container">&nbsp;</label>
				-->
				<input class="w3-check annotator" type="checkbox" checked="checked" id="EDL" disabled="true">
				<label class="container">EDL</label>
			</div>
			<div class="w3-right">
				<!-- <div class="w3-left">
